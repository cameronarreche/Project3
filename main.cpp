    ...
    while (abort > 0) {
        ...
        if (stocks.find(ticker) == stocks.end()) {
            ...
            if (input == "BUY") {
                ...
                auto durationTree = duration_cast<milliseconds>(stopTree - startTree);
                cout << "Time taken to find max index in Tree in milliseconds: " << durationTree.count() << endl;
                ...
                stopTree = high_resolution_clock::now();
                auto durationTree = duration_cast<milliseconds>(stopTree - startTree);
                cout << "Time taken to find minimum index in milliseconds: " << durationTree.count() << endl;
